...
const Icons = {
    ...
    Minimize: () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3" /></svg>,
};
...
export const TopToolbar: React.FC = () => {
    ...
    return (
        <div className="flex items-center justify-end w-full h-10 px-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-[#131722]">
            {/* Fullscreen Button */}
            <button onClick={toggleFullscreen} className={btnClass} title={isFullscreen ? "Exit Fullscreen (F)" : "Fullscreen (F)"}>
